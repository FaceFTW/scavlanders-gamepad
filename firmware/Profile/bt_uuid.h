/**********************************************************************
 * \headerfile: bt_uuid.h
 * \author Alex Westerman
 * Date Created: Feb 18, 2021
 * \brief Prototype header containing a bunch of UUIDs defined by the Bluetooth SIG
 ***********************************************************************/
#ifndef PROFILE_BT_UUID_H_
#define PROFILE_BT_UUID_H_

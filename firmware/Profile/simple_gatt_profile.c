 ...
 * \brief		Main code defining Bluetooth HID profile and functionality
...
#include <ti/sap/snp.h>					//TI Simple Network Protocol (SNP) Library
#include <ti/sap/snp_rpc.h>				//TI SNP Remote Procedure Call (RPC) Library
#include <ti/sap/sap.h>					//TI Simple Application Processor Code

#include "simple_gatt_profile.h"		//Prototypes for this source file
#include "profile_util.h"				//Common Bluetooth Profile Code
